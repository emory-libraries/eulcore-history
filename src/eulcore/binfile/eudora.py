 ...
 * :class:`Toc` -- a :class:`~eulcore.binfile.BinaryStructure` for the index
   file header
 * :class:`Message` -- a :class:`~eulcore.binfile.BinaryStructure` for the
   fixed-length email metadata entries in the index files
'''

from eulcore import binfile

class Toc(binfile.BinaryStructure):
    '''A :class:`~eulcore.binfile.BinaryStructure` for an email folder index
    header.
...
class Message(binfile.BinaryStructure):
    '''A :class:`~eulcore.binfile.BinaryStructure` for a single email's
